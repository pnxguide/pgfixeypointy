...
#error \
    "The only supported platforms are x86_64 and AArch64, PowerPC (work in progress), s390x (work in progress) and RISC-V 64 (experimental)"
#endif
...
#else  /// It does not work in GCC. GCC 7 cannot recognize this attribute and
       /// GCC 8 simply ignores it.
